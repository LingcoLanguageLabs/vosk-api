...
class Recognizer {
    ...
    private:
        ...
        // Named grammar paths retain an opaque marker at their end so callers
        // can associate decoder evidence with a supplied path.
        std::vector<string> grammar_path_ids_;
        int32 grammar_path_label_base_ = 1000000;
        bool words_ = false;
